...
contains:a}}}());hljs.registerLanguage("mojolicious",function(){"use strict";return function(e){
...
excludeEnd:!0}]}}}());hljs.registerLanguage("nginx",function(){"use strict";return function(e){var n={
...
illegal:"[^\\s\\}]"}}}());hljs.registerLanguage("ruby",function(){"use strict";return function(e){
var n="[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",a={
...
return{name:"Plain text",aliases:["text","txt"],disableAutodetect:!0}}}());hljs.registerLanguage("ini",function(){"use strict";function e(e){
